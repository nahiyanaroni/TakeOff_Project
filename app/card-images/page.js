  ...
  return (
    <div className="px-6 md:px-16 lg:px-40 py-16 bg-[#f4faff]">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-8 grid-cols-1 mt-10">
          {/* img-1 */}
          <div className="relative">
            ...
            />
            <div className="absolute bottom-8 ml-6 text-white ">
              <div className="flex gap-2 mb-4">
                <h1 className="text-4xl font-bold ">Rajshahi</h1>
                <p className="bg-yellow-500 text-sm text-black p-2 rounded-full">
                  18 Packages
                </p>
              </div>
              <div className="flex gap-2 ">
                <p className="mt-1">Starts From</p>
                <h1 className="text-xl font-bold ">BDT 55,500</h1>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1  h-auto gap-8">
            {/* img-4 */}
            <div className="relative">
              <img
                src="image 37 (1).png"
